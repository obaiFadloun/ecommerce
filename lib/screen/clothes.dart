...
class ClothesProduct extends StatefulWidget {
  @override
  _ClothesProductState createState() => _ClothesProductState();
}

class _ClothesProductState extends State<ClothesProduct> {
