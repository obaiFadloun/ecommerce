            ...
            child: Row(
              children: <Widget>[
                Container(
                  alignment: Alignment.center,
                  child: InkWell(
                    onTap: ()=> Get.to(VisaPaymentScreen()),
                    child: Image.network(ImageVisaCard,
...
class _VisaPaymentScreenState extends State<VisaPaymentScreen> {
  ...
  bitcoinAddressController = TextEditingController();
